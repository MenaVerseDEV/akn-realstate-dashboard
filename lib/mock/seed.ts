...
export function createSeedData() {
  ...
  const footer: Footer = {
    ...
    socials: [
      ...
      { id: "sl2", platform: "twitter", url: "https://twitter.com", icon: "solar:twitter-bold", order: 1 },
      { id: "sl3", platform: "linkedin", url: "https://linkedin.com", icon: "solar:linkedin-bold", order: 2 },
      { id: "sl4", platform: "facebook", url: "https://facebook.com", icon: "solar:facebook-bold", order: 3 },
    ],
    createdAt: now(),
    updatedAt: now(),
  };
